...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 z-50 w-full h-16 sm:h-20 flex justify-between items-center px-10 md:px-20 font-Playfair font-semibold text-cust-light-cream rounded-b-[40px] sm:rounded-b-[56px] drop-shadow-2xl ${
